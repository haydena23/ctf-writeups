$input = "C:\Users\tones\OneDrive\Documents\Senior\CTF\PicoCTF Challenges\Reverse Engineering\Powershelly\input.txt"

#$out = Get-Content -Path $input
$out = "C:\Users\tones\OneDrive\Documents\Senior\CTF\PicoCTF Challenges\Reverse Engineering\Powershelly\input.txt"
$enc = [System.IO.File]::ReadAllBytes("$input")
$encoding = [system.Text.Encoding]::UTF8
$total = 264
$t = ($total + 1) * 5 # $t = 1365
$numLength = ($total * 30 ) + $t # numLength = 9,285
